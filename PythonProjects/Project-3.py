# How to program a DRS review system in cricket using Python.

# DRS review system is a very popular technology in cricket with a good amount of Python logic
# to implement which makes this video a good source of logic building in Python.
